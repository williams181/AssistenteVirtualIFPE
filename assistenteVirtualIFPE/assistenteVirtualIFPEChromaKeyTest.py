...
if __name__=='__main__':
    ...
    cap = cv2.VideoCapture('assistenteVirtualIFPE\\videos chromakey\\Speaking Mouths Free green screen mouth movement animation talking mouth green.mp4')  # Captura o arquivo de vídeo
    while cap:
